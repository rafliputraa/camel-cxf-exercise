...
public class Calculator extends Service {
    ...
    static {
        URL url = Calculator.class.getClassLoader().getResource("wsdl/sample.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "classpath:wsdl/sample.wsdl");
        }
        WSDL_LOCATION = url;
    }
